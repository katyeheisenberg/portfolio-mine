...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Kate Chicherina
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home__description">Hello! I'm React Frontend Developer. And I'm very dedicated to my work and passionate about improving my proffesional skills.</p>
