  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        Enthusiastic and innovative JavaScript Developer passionate about
        bringing projects to life through code, with a demonstrated ability to
        enhance and develop new and existing projects. Exceptional communication
        skills ensure seamless integration and effective collaboration within
        diverse teams. Naturally adaptive and a quick learner, I thrive in
        dynamic environments and continually seek out new technologies to stay
